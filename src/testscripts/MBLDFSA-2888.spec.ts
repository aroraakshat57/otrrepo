...
for (const record of records) {
    test.only(`Verify whether create new deal is working properly using Baumster ${record.Baumster}`, async ({ browser },testInfo) => {
      ...
      actualresult = await otrApp.addFinancialServices();
      const locator = page.locator('p:has-text("Update erfolgreich")');
